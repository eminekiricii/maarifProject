...
import { CreateStudentDialogComponent } from './create-student/create-stundent-dialog.component';
import { EditStundentDialogComponent } from './edit-student/edit-stundent-dialog.component';
...
export class StudentsComponent extends PagedListingComponentBase<TenantDto> {
    tenants: TenantDto[] = [];
    keyword = '';
    isActive: boolean | null;
    ...
    showCreateOrEditTenantDialog(id?: number): void {
        ...
        if (id === undefined || id <= 0) {
            createOrEditTenantDialog = this._dialog.open(CreateStudentDialogComponent);
        } else {
            createOrEditTenantDialog = this._dialog.open(EditStundentDialogComponent, {
                data: id
            });
        }
